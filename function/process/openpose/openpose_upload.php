                ...
                <div class="row">
                    <div class="col-sm-12">
                        <?php
                            ...
                            // $uploadfile = 'http://210.125.126.112:8080/function/uploads/'. $_FILES['upload']['name']; // changed
                            if(move_uploaded_file($_FILES['upload']['tmp_name'], $uploadfile)){
                                ...
                                echo "<br><a class='btn btn-info' href='http://210.125.126.112:8080/function/process/openpose/openpose_result.php?{$_FILES['upload']['name']}'>결과 확인</a>";
                            } else {
