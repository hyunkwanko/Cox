<?php
    ...
    // python faceswap.py extract -i ./kth_Trim.mp4 -o ./kth
    ...
    function extract_process(){     
        ...
        $video_path = 'C:/Apache24/htdocs/view/deepfake/'.$_GET['file']; // Input Video
        // echo $video_path . "<br>";
    ...
    echo "<script> document.location.href='../../view/deepfake/view_extract.php?file=".$_GET['file']."'; </script>"; // Redirection
?>