                  ...
                  <div class="single_appartment_content">
                     <div class="contents" style="text-align:center;">
                        <div class="container">
                           <div class="row">
                              <div class="col-sm-12">
                                 <button type="button" style="background-color:#ffc10794; border-radius:1rem; border:none;"><a href="<?php ROOT?>/pages/gan/conversion_new_process.php?file=<?php echo $_GET['file'];?>&model=<?php echo $_GET['model'];?>"><b>Conversion</b></a></button>&emsp;
